...
namespace ScrumApp.View
{
    ...
    /// </summary>
    public sealed partial class DetailUserView : ScrumApp.Common.LayoutAwarePage
    {
        ...
        public DetailUserView()
        {
            ...
            detailUserViewModel = new DetailUserViewModel();
            DataContext = detailUserViewModel;
        }
